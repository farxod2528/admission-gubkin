...
!function(t, e) {
    ...
    var Yt = {
        ...
        limitCanvas: function(t, e) {
            ...
            if (t) {
                ...
                1 < r ? (c = Math.max(c, a.width),
                l = Math.max(l, a.height),
                3 === r && (c < l * h ? c = l * h : l = c / h)) : 0 < r && (c ? c = Math.max(c, s ? o.width : 0) : l ? l = Math.max(l, s ? o.height : 0) : s && ((c = o.width) < (l = o.height) * h ? c = l * h : l = c / h));
                var d = Nt({
                    aspectRatio: h,
                    width: c,
                    height: l
        ...
        limitCropBox: function(t, e) {
            ...
            if (t) {
                ...
                h && (s && c ? s < c * h ? c = s / h : s = c * h : s ? c = s / h : c && (s = c * h),
                l < d * h ? d = l / h : l = d * h),
        ...
        renderCropBox: function() {
            ...
            i.oldLeft = i.left,
            i.oldTop = i.top,
            t.movable && t.cropBoxMovable && wt(this.face, g, i.width >= e.width && i.height >= e.height ? k : D),
            dt(this.cropBox, ht({
                width: i.width,
                height: i.height
            }, Et({
        ...
        output: function() {
            this.preview(),
            Ct(this.element, y, this.getData())
        }
    }
      , Xt = {
      ...
      , Rt = {
        bind: function() {
            ...
            e.zoomable && e.zoomOnWheel && Mt(i, "wheel", this.onWheel = this.wheel.bind(this), {
                passive: !1,
                capture: !0
            }),
            e.toggleDragModeOnDblclick && Mt(i, j, this.onDblclick = this.dblclick.bind(this)),
        ...
        unbind: function() {
            ...
            e.zoomable && e.zoomOnWheel && xt(i, "wheel", this.onWheel, {
                passive: !1,
                capture: !0
            }),
      ...
      , jt = {
        resize: function() {
            ...
            if (!(this.disabled || i.width <= a || i.height <= n)) {
                ...
                if (1 != h || e.offsetHeight !== i.height)
                    ...
                    this.render(),
                    t.restore && (this.setCanvasData(rt(o, function(t, e) {
                        o[e] = t * h
                    })),
        ...
        cropStart: function(t) {
            ...
            if (!(this.disabled || ("mousedown" === t.type || "pointerdown" === t.type && "mouse" === t.pointerType) && (V(e) && 1 !== e || V(i) && 0 !== i || t.ctrlKey))) {
                ...
                a = 1 < Object.keys(o).length && n.zoomable && n.zoomOnTouch ? O : vt(t.target, g),
                $.test(a) && !1 !== Ct(this.element, R, {
                    originalEvent: t,
                    action: a
                }) && (t.preventDefault(),
                this.action = a,
      ...
      , At = {
        change: function(t) {
            var e, i = this.options, a = this.canvasData, n = this.containerData, o = this.cropBoxData, r = this.pointers, h = this.action, s = i.aspectRatio, c = o.left, l = o.top, d = o.width, p = o.height, u = c + d, m = l + p, g = 0, f = 0, v = n.width, w = n.height, b = !0;
            ...
            case B:
                ...
                d = o.minWidth,
                p = o.minHeight,
                0 < M.x ? h = 0 < M.y ? z : H : M.x < 0 && (c -= d,
                h = 0 < M.y ? Y : L),
                M.y < 0 && (l -= p),
                this.cropped || (ut(this.cropBox, X),
                this.cropped = !0,
      ...
      , St = {
        ...
        reset: function() {
            return this.ready && !this.disabled && (this.imageData = ht({}, this.initialImageData),
        ...
        moveTo: function(t, e) {
            ...
            return t = Number(t),
            i = Number(i),
            this.ready && !this.disabled && this.options.movable && (V(t) && (a.left = t,
            n = !0),
            V(i) && (a.top = i,
            n = !0),
        ...
        zoomTo: function(t, e, i) {
            ...
            if (0 <= (t = Number(t)) && this.ready && !this.disabled && a.zoomable) {
                ...
                if (i) {
                    ...
                    it(e) && V(e.x) && V(e.y) ? (n.left -= (c - o) * ((e.x - n.left) / o),
        ...
        rotateTo: function(t) {
            return V(t = Number(t)) && this.ready && !this.disabled && this.options.rotatable && (this.imageData.rotate = t % 360,
        ...
        scale: function(t, e) {
            ...
            return t = Number(t),
            i = Number(i),
            this.ready && !this.disabled && this.options.scalable && (V(t) && (a.scaleX = t,
            n = !0),
            V(i) && (a.scaleY = i,
            n = !0),
        ...
        getData: function(t) {
            var i, e = 0 < arguments.length && void 0 !== t && t, a = this.options, n = this.imageData, o = this.canvasData, r = this.cropBoxData;
        ...
        setData: function(t) {
            ...
            if (this.ready && !this.disabled && it(t)) {
                var o = !1;
                e.rotatable && V(t.rotate) && t.rotate !== i.rotate && (i.rotate = t.rotate,
                o = !0),
                e.scalable && (V(t.scaleX) && t.scaleX !== i.scaleX && (i.scaleX = t.scaleX,
                o = !0),
                V(t.scaleY) && t.scaleY !== i.scaleY && (i.scaleY = t.scaleY,
                o = !0)),
        ...
        setCanvasData: function(t) {
            var e = this.canvasData
              , i = e.aspectRatio;
            return this.ready && !this.disabled && it(t) && (V(t.left) && (e.left = t.left),
            V(t.top) && (e.top = t.top),
            V(t.width) ? (e.width = t.width,
            e.height = t.width / i) : V(t.height) && (e.height = t.height,
            e.width = t.height * i),
            this.renderCanvas(!0)),
            this
        },
        ...
        setCropBoxData: function(t) {
            ...
            return this.ready && this.cropped && !this.disabled && it(t) && (V(t.left) && (a.left = t.left),
            V(t.top) && (a.top = t.top),
            V(t.width) && t.width !== a.width && (e = !0,
            a.width = t.width),
            V(t.height) && t.height !== a.height && (i = !0,
            a.height = t.height),
        ...
        getCroppedCanvas: function(t) {
            ...
            var i = this.canvasData
              , a = function(t, e, i, a) {
                ...
                N.drawImage.apply(N, [t].concat(P(S.map(function(t) {
            ...
            E <= -h || O < E ? B = C = x = E = 0 : E <= 0 ? (C = -E,
            E = 0,
            B = x = Math.min(O, h + E)) : E <= O && (C = 0,
            B = x = Math.min(h, O - E)),
            x <= 0 || W <= -s || T < W ? k = D = M = W = 0 : W <= 0 ? (D = -W,
            W = 0,
            k = M = Math.min(T, s + W)) : W <= T && (D = 0,
            k = M = Math.min(s, T - W));
            var N = [E, W, x, M];
            if (0 < B && 0 < k) {
                var H = m / h;
        ...
        return function(t, e, i) {
            ...
            value: function() {
                var t = this.element
                  ...
                  , i = t.crossOrigin
                  , a = e;
                this.options.checkCrossOrigin && Ot(e) && (i = i || "anonymous",
                a = Tt(e)),
                this.crossOrigin = i,
            ...
            value: function() {
                if (this.sized && !this.ready) {
                    ...
                    pt(s, X),
                    e.guides || pt(s.getElementsByClassName("".concat(d, "-dashed")), X),
                    e.center || pt(s.getElementsByClassName("".concat(d, "-center")), X),
                    e.background && pt(o, "".concat(d, "-bg")),
                    e.highlight || pt(c, u),
                    e.cropBoxMovable && (pt(c, m),
                    wt(c, g, D)),
                    e.cropBoxResizable || (pt(s.getElementsByClassName("".concat(d, "-line")), X),
    ...
    if (ht(It.prototype, Yt, Xt, Rt, jt, At, St),
    l.fn) {
        var Ut = l.fn.cropper
          , qt = "cropper";
        l.fn.cropper = function(h) {
            for (var t = arguments.length, s = new Array(1 < t ? t - 1 : 0), e = 1; e < t; e++)
                s[e - 1] = arguments[e];
            var c;
            return this.each(function(t, e) {
                ...
                if ("string" == typeof h) {
                    var r = n[h];
                    l.isFunction(r) && ((c = r.apply(n, s)) === n && (c = void 0),
                    a && i.removeData(qt))
                }
            }),
            void 0 !== c ? c : this
